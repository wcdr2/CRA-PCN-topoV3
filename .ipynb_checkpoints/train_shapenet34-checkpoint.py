...
def ShapeNet34Config():
    ...
    __C.DATASETS.SHAPENET55.CATEGORY_FILE_PATH       = '/root/autodl-tmp/PoinTr/data/ShapeNet55-34/ShapeNet-34/'
    __C.DATASETS.SHAPENET55.N_POINTS                 = 2048
    __C.DATASETS.SHAPENET55.COMPLETE_POINTS_PATH     = '/root/autodl-tmp/PoinTr/data/ShapeNet55-34/shapenet_pc/%s'
